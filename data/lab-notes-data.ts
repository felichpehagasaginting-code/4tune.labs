...
export const LAB_NOTES_DATA: LabArticle[] = [
  ...
  },
  {
    ...
    content: [
      "Setiap minggu di Lab Asrama SCWE Kamar 304, kami kerap menerima HP dengan kondisi 'mati total'. Reaksi pertama pemilik biasanya panik lalu mencolokkan charger berulang-ulang berjam-jam, atau buru-buru membeli baterai baru di e-commerce. Padahal, jika ada sirkuit yang korslet di dalam, menyuntikkan arus listrik terus-menerus justru berisiko membakar chip prosesor (CPU) atau IC Power utama.",
