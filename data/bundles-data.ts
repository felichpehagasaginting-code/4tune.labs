...
export const BUNDLES_DATA: BundleItem[] = [
  ...
  {
    id: "bundle-hp-revive",
    badge: "Solusi Cepat Gadget",
    badgeType: "hot",
    title: "Paket HP Segar & Normal Kembali",
    targetUser: "Smartphone retak, baterai cepat drop, port cas longgar, atau speaker suara pelan/kresek.",
    priceDisplay: "Mulai Rp 160.000",
    priceNote: "Sudah ALL-IN termasuk unit sparepart baru + jasa pasang & bersihkan",
    description: "Solusi komprehensif mengembalikan HP kesayangan kembali mulus: penggantian layar LCD/baterai baru, pembersihan ultrasonik port charging, deep cleaning mesh speaker, dan uji kelistrikan daya.",
    features: [
      "Pilihan Layar Berkualitas (Incell / OLED / Original OEM)",
      "Penggantian Baterai High-Capacity Awet Anti-Drop",
      "Pembersihan Mesh Akustik & Rekondisi Port Cas Type-C",
      "Diagnosa Sirkuit & Jalur Tegangan DC Power Supply",
      "Garansi Pengerjaan & Diskon 10% Spesial Hari Jum'at",
    ],
    ctaText: "Ambil Paket Servis HP",
    waLink: "https://wa.me/6283159392826?text=Hai%20Zulkifli%2C%20saya%20tertarik%20dengan%20Paket%20HP%20Segar%20%26%20Normal%20Kembali%20untuk%20smartphone%20saya.",
    leadPerson: "Zulkifli (Mamad) — Spesialis Reparasi HP & Gadget",
  },
];
